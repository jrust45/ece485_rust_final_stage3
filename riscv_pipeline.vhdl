   ...
   component alu_control is
    ...
    component pipeline_registers 
        Port (
            ...
            -- did not include alu_result, alu_op, instr, rs1, or rs2
...
--------------------------------------------------------------------------------
    ...
    reg_file_inst: reg_file
        ...
        if_id_reg1_data <= wb_data when (mem_wb_reg_write = '1' and mem_wb_rd = if_id_instr(19 downto 15) and mem_wb_rd /= "00000") else
                            reg1_data;
        if_id_reg2_data <= wb_data when (mem_wb_reg_write = '1' and mem_wb_rd = if_id_instr(24 downto 20) and mem_wb_rd /= "00000") else
                            reg2_data;
    ...
    -- PC and IF/ID register updates within pipeline_registers.vhdl
...
----------------------------------------------------------------------------------------
    ...
    next_pc <= std_logic_vector(signed(ex_mem_npc) + shift_left(signed(ex_mem_imm), 1)) when (ex_mem_branch = '1' and not_equal_flag = '1') else -- branch case
               ...
               pc when (stall_counter > 1 or start_stall = '1') else
